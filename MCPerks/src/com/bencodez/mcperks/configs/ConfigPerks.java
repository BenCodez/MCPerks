...
public class ConfigPerks {
	...
	@SuppressWarnings("unchecked")
	public ArrayList<String> getGlobalCommands(String perk) {
		return (ArrayList<String>) getData(perk).getList("GlobalCommands", new ArrayList<String>());
	}
	...
	public ArrayList<String> getLoreActive(String perk) {
		return (ArrayList<String>) getData(perk).getList("Lore.Active", plugin.getConfigFile().getLoreActive());
	}

	@SuppressWarnings("unchecked")
	public ArrayList<String> getLoreAvailable(String perk) {
		return (ArrayList<String>) getData(perk).getList("Lore.Available", plugin.getConfigFile().getLoreAvailable());
	}

	@SuppressWarnings("unchecked")
	public ArrayList<String> getLoreInCoolDown(String perk) {
		return (ArrayList<String>) getData(perk).getList("Lore.InCoolDown", plugin.getConfigFile().getLoreInCoolDown());
	}

	@SuppressWarnings("unchecked")
	public ArrayList<String> getLoreLimitReached(String perk) {
		return (ArrayList<String>) getData(perk).getList("Lore.LimitReached",
				plugin.getConfigFile().getLoreLimitReached());
	}
	...
	public ArrayList<String> getPerkDisabledWorlds(String perk) {
		return (ArrayList<String>) getData(perk).getList("DisabledWorlds", plugin.getConfigFile().getDisabledWorlds());
	}
